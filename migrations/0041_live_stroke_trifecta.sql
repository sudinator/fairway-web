-- 0041_live_stroke_trifecta.sql
-- The live (public share) scorecard RPC predates two columns: trifecta_scoring
-- (added 0024) and stroke_basis (added 0035). Without them the read-only page
-- can't tell a "match"-scored trifecta from per-hole, and can't tell gross from
-- net for Stroke play. This re-creates get_live_scorecard adding ONLY those two
-- fields to the game object; everything else is identical to 0021.
